...
graph = read_uai("./data/test.uai.txt")
graph.add_uai_evid("./data/test.uai.evid.txt")
min_fill(graph)
for n in graph.get_nodes():
    print n.get_index()
    for neighbor in n.get_neighbor():
        print '\t%d' % neighbor.get_index()
# max_cliques = MSC(graph)
# root = generate_junction_tree(max_cliques)
