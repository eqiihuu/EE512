...
class Network(object):
    def __init__(self, uai_path, evid_path):
    ...
    #     prev_cdn.add(prev_v_elim)
    #     max_cliques.append(prev_cdn)
    #     return max_cliques  # A list of set(int)
    ...
    #         cliques.append(Cluster(clique, set()))
...
if __name__ == '__main__':
    uai_path = './data/1.uai.txt'
    evid_path = './data/1.uai.evid.txt'
